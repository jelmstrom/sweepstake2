            ...
            <div class="col-xs-12 col-md-10 col-md-offset-1">
                ...
                <div class="col-xs-6 col-md-4 col-md-offset-1" id="group-predicted-outcome">
                    <form role="form" id="frm-predicted-table">
                        ...
                        <div class="form-group">
                            <input type="text" name="username" id="position2" class="form-control input-sm" placeholder="Position 2" required/>
                        </div>
                        <div class="form-group">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-10 col-md-offset-1">
               <table class="table">
                   ...
                   <tr>
                       <td id="group-match-date-0"></td>
                       <td id="group-match-home-0"></td>
                       <td id="group-match-away-0"></td>
                   ...
                   <tr>
                       <td id="group-match-date-1"></td>
                       <td id="group-match-home-1"></td>
                       <td id="group-match-away-1"></td>
                   ...
                   <tr>
                       <td id="group-match-date-2"></td>
                       <td id="group-match-home-2"></td>
                       <td id="group-match-away-2"></td>
                   ...
                   <tr>
                       <td id="group-match-date-3"></td>
                       <td id="group-match-home-3"></td>
                       <td id="group-match-away-3"></td>
                   ...
                   <tr>
                       <td id="group-match-date-4"></td>
                       <td id="group-match-home-4"></td>
                       <td id="group-match-away-4"></td>
                   ...
                   <tr>
                       <td id="group-match-date-5"></td>
                       <td id="group-match-home-5"></td>
                       <td id="group-match-away-5"></td>
    ...
    <script>
        this.on('mount', function () {
            $("#btn-group-submit-result").on("click", function(event){
                ...
                var user = main.user();
                user.predictions = []; // clean out the predictions because jackson complains abour duplicate matches
                var predictions =
                    [
                        {
                            id: null,
                            ...
                            homeGoals: $("#homeGoals0").val(),
                            awayGoals: $("#awayGoals0").val()
                        },
                        {
                            id: null,
                            user: user.id,
                ...
                main.makeAjaxCall('/rest/match/predictions/', 'POST', predictions)
